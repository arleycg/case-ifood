...
#### - OBS: O link fornecido no case para download dos dados esta indisponível conforme imagem abaixo. Realizei uma busca e encontrei a API para download dos dados:  [Yellow Taxi Trip Data](http://data.cityofnewyork.us/Transportation/2023-Yellow-Taxi-Trip-Data/4b4i-vvec/about_data)
